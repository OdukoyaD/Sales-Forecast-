...
def main():
    ...
    st.sidebar.image('s3://intern-t26-2201-sales-forecasting/Images/walmart_img.jpg',use_column_width=True)
    ...
    if page_selection == "About":
       ...
       st.image('s3://intern-t26-2201-sales-forecasting/Images/Walmartlogo.jpg',use_column_width=True)
    ...
    if page_selection == "EDA":
            ...
            if select_option == 'Sales per year':
                ...
                st.image('s3://intern-t26-2201-sales-forecasting/Images/%yearly sale.jpg')
            ...
            if select_option == 'Income per state':
                ...
                st.image('s3://intern-t26-2201-sales-forecasting/Images/income per state.jpg')
                st.info('Show the income generated per state within the given years.') 
                st.image('s3://intern-t26-2201-sales-forecasting/Images/sale per state.jpg.jpg')
                st.info('A display of the  snap sales per state.') 

            if select_option == 'Monthly sales':
                st.subheader('monthly sales ')
                st.image('s3://intern-t26-2201-sales-forecasting/Images/%monthly sale.jpg') 
            ...
            if select_option == 'Daily sales':
                ...
                st.image('s3://intern-t26-2201-sales-forecasting/Images/sales per day.jpg') 
            ...
            if select_option == 'Department sales':
                ...
                st.image('s3://intern-t26-2201-sales-forecasting/Images/income per dept.jpg')
                ...
                st.image('s3://intern-t26-2201-sales-forecasting/Images/dept sale.jpg')
